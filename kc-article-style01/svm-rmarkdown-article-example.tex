...
\title{Information Security on a Page \thanks{Bestand beschikbaar op <locatie>
(\url{http://}). \textbf{Huidige versie}: v0.0
2020; \textbf{Auteur}:
\href{mailto:koen.colpaert@vlaanderen.be}{\nolinkurl{koen.colpaert@vlaanderen.be}}.}  }



\author{\Large Koen Colpaert\vspace{0.05in} \newline\normalsize\emph{Dep. FB}  }
...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Koen Colpaert (DFB)},
             pdfkeywords = {security, strategie},  
...
\textbf{\authorfont Koen Colpaert} \hskip 15pt \emph{\small Departement Financiën en Begroting - Afdeling POEMA}   
...
\vskip 8.5pt \noindent \emph{Keywords}: security, strategie, visiedocument \par
...
\section{Documenteigenschappen}

\begin{tabular}{|l|c|l|}
\hline 
Versie & Datum & Aanpassing \\ 
\hline 
0.1 & 19/07/2020 & Initiële versie \\ 
\hline 
0.2 & • & Opmerkingen Ad Krikke (Gartner) \\ 
\hline 
\end{tabular} 
